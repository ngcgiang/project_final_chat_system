...
public class AdminListManagement extends JFrame {
    ...
    public AdminListManagement() {
        ...
        filterComboBox = new JComboBox<>(new String[]{"Group ID", "Admin ID"});
        ...
        tableModel = new DefaultTableModel(new Object[]{"Group ID", "Admin ID"}, 0);
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new AdminListManagement());
    }
}
